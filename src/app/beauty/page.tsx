...
export default async function Page() {  
  ...
  const products:typeProduct[] = await getProductsByCategory("beauty")


  return (
    <>
      <div className="min-h-screen grid grid-rows-[auto_1fr_auto]">
        <Navbar path={"/beauty"} User = {currentUser} />
        <main className="grow">
 ...
 <GetSliderImages category={"beauty"} title={"Découvrez tous les produits de la catégorie BEAUTE chez RonaldShop"} /> 
